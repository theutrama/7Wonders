...
public class TradingSystemTest {
	...
	public void testTrading() {
		...
		Card card2 = new Card(1, "card 2", "card 2", CardType.BROWN, null, null, new String[] { "card 1" }, null);
		Card card3 = new Card(1, "card 3", "card 3", CardType.BROWN, null, createList(new Resource(1, ResourceType.ORE)), null, null);
		...
		assertEquals(BuildCapability.OWN_RESOURCE,
				controller.getPlayerController().hasResources(player3, createList(new Resource(1, ResourceType.ORE), new Resource(1, ResourceType.ORE))));
		...
		assertEquals(BuildCapability.TRADE,
				controller.getPlayerController().hasResources(player2, createList(new Resource(1, ResourceType.ORE), new Resource(1, ResourceType.ORE))));
		assertEquals(BuildCapability.TRADE,
				controller.getPlayerController().hasResources(player2, createList(new Resource(1, ResourceType.ORE), new Resource(1, ResourceType.WOOD))));
		assertEquals(BuildCapability.TRADE,
				controller.getPlayerController().hasResources(player2, createList(new Resource(1, ResourceType.ORE), new Resource(1, ResourceType.GLASS))));
		assertEquals(BuildCapability.NONE,
				controller.getPlayerController().hasResources(player2, createList(new Resource(1, ResourceType.ORE), new Resource(1, ResourceType.PAPYRUS))));
		player2.addCoins(-2);
		...
		assertEquals(BuildCapability.TRADE,
				controller.getPlayerController().hasResources(player2, createList(new Resource(2, ResourceType.ORE), new Resource(1, ResourceType.WOOD))));
	...
	@SafeVarargs
	private static <T> ArrayList<T> createList(T... bundles) {
